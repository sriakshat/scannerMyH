$(function() {
    var App = {
		...
		captureImgDecode(){
			...
			barcodeContext.drawImage(document.getElementById('video'), 0, 0, imageWidth, imageHeight);
			var imageData = barcodeContext.getImageData(0, 0, imageWidth, imageHeight);
			var img = new Image();
			img.src = barcodeCanvas.toDataURL();
			const byteCharacters = atob(barcodeCanvas.toDataURL().replace(/^data:image\/(png|jpeg|jpg);base64,/, ''));
			...
			App.decode(URL.createObjectURL(blob));
		},
